        ...
        <div class="field-block">
            ...
            <select id="f_checker">
                <?php foreach ($checkers as $ch): ?>
                    <option value="<?= $ch['id'] ?>" <?= isset($draft) && $draft && $ch['id'] == $draft['checker_id'] ? 'selected' : '' ?>><?= htmlspecialchars($ch['name']) ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="field-block">
            ...
            <select id="f_shift">
                <?php foreach ($shifts as $s): ?>
                    <option value="<?= $s['id'] ?>" <?= isset($draft) && $draft && $s['id'] == $draft['shift_id'] ? 'selected' : '' ?>><?= htmlspecialchars($s['name']) ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
