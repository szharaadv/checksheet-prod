...
// Checked By entries scoped strictly to this section — keeps FO Pump
// Assy's Foreman/Supervisor lists from mixing with Torque/Washing/Sub
// Assembly's, which share the same department_id. Routing lives entirely
