...
<table class="admin-table">
    <thead>
        <tr>
            <th>Date</th>
            <th>Surface Out Side</th>
            <th>Parting Line</th>
            <th>Surface Upper Side</th>
            <th>Cleanliness</th>
            <th>Checker</th>
            <th>Control</th>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= htmlspecialchars($row['surface_outside'] ?: '-') ?></td>
            <td><?= htmlspecialchars($row['parting_line'] ?: '-') ?></td>
            <td><?= htmlspecialchars($row['surface_upper'] ?: '-') ?></td>
            <td><?= htmlspecialchars($row['cleanliness'] ?: '-') ?></td>
